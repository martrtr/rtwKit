...
core="$repo_root/target/wasm32-unknown-unknown/release/rintawa_character_library_handler.wasm"
...
cargo run --quiet --locked -p rtwkit-componentize -- "$core" "$output/content-handler.wasm"
